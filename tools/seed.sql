...
--local
insert into chemix_markets (id,base_token_address,base_token_symbol,base_front_decimal,base_contract_decimal,quote_token_address,quote_token_symbol,quote_front_decimal,quote_contract_decimal,online,up_at,down_at,created_at) values ('BTC-USDT', '0x7DBF554b459cFb39C7B92e6AA2FA85Bb1B9aCcF1','BTC', 8,18,'0xAf4984736dAe2e795A8199C01341DA46460a6096','USDT', 8,15, true,NOW(),NOW() + '10 years',NOW());
