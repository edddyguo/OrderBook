...
--local
insert into chemix_markets (id,base_token_address,base_token_symbol,base_front_decimal,base_contract_decimal,quote_token_address,quote_token_symbol,quote_front_decimal,quote_contract_decimal,online,up_at,down_at,created_at) values ('BTC-USDT', '0x12B4e1E58D2EEc9B984A18D7275359E269726Dc2','BTC', 8,18,'0x1B1D8299C787046dE1Be0CCb80aBfeb7Bf126809','USDT', 8,15, true,NOW(),NOW() + '10 years',NOW());
